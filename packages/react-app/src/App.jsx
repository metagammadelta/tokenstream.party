...
const scaffoldEthProvider = navigator.onLine
  ? new ethers.providers.StaticJsonRpcProvider("https://eth-mainnet.alchemyapi.io/v2/u-WB__GlHGH4e6XQR4M-aD5b9TtlZdMI")
  : null;
...
const walletLinkProvider = walletLink.makeWeb3Provider(
  "https://eth-mainnet.alchemyapi.io/v2/u-WB__GlHGH4e6XQR4M-aD5b9TtlZdMI",
  1,
);
  ...
  providerOptions: {
    walletconnect: {
      ...
      options: {
        ...
        infuraId: INFURA_ID,
        rpc: {
          1: "https://eth-mainnet.alchemyapi.io/v2/u-WB__GlHGH4e6XQR4M-aD5b9TtlZdMI", // mainnet // For more WalletConnect providers: https://docs.walletconnect.org/quick-start/dapps/web3-provider#required
